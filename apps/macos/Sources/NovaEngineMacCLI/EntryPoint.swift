...
struct NovaEngineMacCLI {
    static func main() async {
        ...
        default:
            fputs("nova-engine-mac: unknown command\n", stderr)
            printUsage()
            exit(1)
        }
    }
...
private func printUsage() {
    ...
    Examples:
      ...
      nova-engine-mac connect --url ws://127.0.0.1:18789 --json
      nova-engine-mac discover --timeout 3000 --json
      nova-engine-mac wizard --mode local
    """)
}
