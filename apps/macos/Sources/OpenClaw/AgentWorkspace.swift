...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.nova-engine", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return NovaEngineConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - NovaEngine Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.nova-engine/nova-engine.json
