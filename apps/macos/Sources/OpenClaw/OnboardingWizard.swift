...
private let onboardingWizardLogger = Logger(subsystem: "ai.nova-engine", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between NovaEngineProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = NovaEngineProtocol.AnyCodable
