...
enum UIStrings {
    static let welcomeTitle = "Welcome to NovaEngine"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: NovaEngineOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: NovaEngineChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g nova-engine@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: NovaEngineChatViewModel(
