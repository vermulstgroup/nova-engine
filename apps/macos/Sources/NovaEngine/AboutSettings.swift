...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/nova-engine/nova-engine") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/nova-engine/nova-engine")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://nova-engine.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "NovaEngineBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "NovaEngineBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "NovaEngineGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "NovaEngineGitCommit") as? String) ??
            "unknown"
    }
