...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .nova-engineSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? NovaEnginePaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? NovaEnginePaths.stateDirURL.path
...
extension Notification.Name {
    static let nova-engineSelectSettingsTab = Notification.Name("nova-engineSelectSettingsTab")
}
