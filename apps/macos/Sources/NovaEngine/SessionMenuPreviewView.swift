...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.nova-engine", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> NovaEngineSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: NovaEngineSessionPreviewEntry,
    ...
    private static func cache(payload: NovaEngineSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: NovaEngineChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [NovaEngineKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [NovaEngineKit.AnyCodable]) -> [NovaEngineChatMessage] {
    ...
    private static func previewText(for message: NovaEngineChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: NovaEngineChatMessage) -> Bool {
    ...
    private static func toolNames(for message: NovaEngineChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: NovaEngineChatMessage) -> String? {
