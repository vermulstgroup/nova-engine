...
enum LaunchAgentManager {
    private static var plistURL: URL {
        FileManager().homeDirectoryForCurrentUser
            .appendingPathComponent("Library/LaunchAgents/ai.nova-engine.mac.plist")
    }
    ...
    private static func writePlist(bundlePath: String) {
        ...
        <dict>
          <key>Label</key>
          <string>ai.nova-engine.mac</string>
          <key>ProgramArguments</key>
          <array>
            <string>\(bundlePath)/Contents/MacOS/NovaEngine</string>
          </array>
