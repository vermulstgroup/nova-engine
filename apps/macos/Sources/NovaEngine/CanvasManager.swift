...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.nova-engine", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("NovaEngine/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__nova-engine__/a2ui/").absoluteString + "?platform=macos"
    }
