...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: NovaEngineProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": NovaEngineProtocol.AnyCodable("start"),
                "name": NovaEngineProtocol.AnyCodable("bash"),
            ],
            summary: nil)
