...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: NovaEnginePhotosLatestParams) async throws -> NovaEnginePhotosLatestPayload {
        ...
        var results: [NovaEnginePhotoPayload] = []
        ...
        return NovaEnginePhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> NovaEnginePhotoPayload
    {
