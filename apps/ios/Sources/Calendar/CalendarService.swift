...
final class CalendarService: CalendarServicing {
    func events(params: NovaEngineCalendarEventsParams) async throws -> NovaEngineCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            NovaEngineCalendarEventPayload(
        ...
        return NovaEngineCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: NovaEngineCalendarAddParams) async throws -> NovaEngineCalendarAddPayload {
        ...
        let payload = NovaEngineCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return NovaEngineCalendarAddPayload(event: payload)
    }
