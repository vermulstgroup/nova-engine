...
final class ScreenController {
    ...
    /// Callback invoked when an nova-engine:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = NovaEngineKitResources.bundle
...
/// Handles navigation policy to intercept nova-engine:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept nova-engine:// deep links.
        if url.scheme?.lowercased() == "nova-engine" {
