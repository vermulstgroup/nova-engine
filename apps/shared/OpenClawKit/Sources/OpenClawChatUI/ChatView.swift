...
@MainActor
public struct NovaEngineChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: NovaEngineChatViewModel
    ...
    public init(
        viewModel: NovaEngineChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                NovaEngineChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [NovaEngineChatMessage] {
        let base: [NovaEngineChatMessage]
    ...
    private func mergeToolResults(in messages: [NovaEngineChatMessage]) -> [NovaEngineChatMessage] {
        ...
        for message in messages {
            ...
            let merged = NovaEngineChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: NovaEngineChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: NovaEngineChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: NovaEngineChatMessage) -> String {
