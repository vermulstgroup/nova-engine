...
public typealias NovaEnginePlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias NovaEnginePlatformImage = UIImage
#endif

public struct NovaEngineChatUsageCost: Codable, Hashable, Sendable {
...
public struct NovaEngineChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: NovaEngineChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(NovaEngineChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct NovaEngineChatMessageContent: Codable, Hashable, Sendable {
...
public struct NovaEngineChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [NovaEngineChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: NovaEngineChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [NovaEngineChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: NovaEngineChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(NovaEngineChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([NovaEngineChatMessageContent].self, forKey: .content) {
...
public struct NovaEngineChatHistoryPayload: Codable, Sendable {
...
public struct NovaEngineSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct NovaEngineSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [NovaEngineSessionPreviewItem]
}

public struct NovaEngineSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [NovaEngineSessionPreviewEntry]

    public init(ts: Int, previews: [NovaEngineSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct NovaEngineChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct NovaEngineChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct NovaEngineAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct NovaEngineChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct NovaEngineGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct NovaEnginePendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: NovaEnginePlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: NovaEnginePlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct NovaEngineChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
