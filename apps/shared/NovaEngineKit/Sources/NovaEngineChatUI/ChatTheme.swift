...
enum NovaEngineChatTheme {
    ...
    static let assistantBubbleDynamicNSColor = NSColor(
        name: NSColor.Name("NovaEngineChatTheme.assistantBubble"),
        dynamicProvider: resolvedAssistantBubbleColor(for:))

    static let onboardingAssistantBubbleDynamicNSColor = NSColor(
        name: NSColor.Name("NovaEngineChatTheme.onboardingAssistantBubble"),
...
enum NovaEnginePlatformImageFactory {
    static func image(_ image: NovaEnginePlatformImage) -> Image {
        #if os(macOS)
        Image(nsImage: image)
        #else
        Image(uiImage: image)
