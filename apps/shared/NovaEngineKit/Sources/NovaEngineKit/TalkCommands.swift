...
public enum NovaEngineTalkCommand: String, Codable, Sendable {
...
public struct NovaEngineTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct NovaEngineTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
