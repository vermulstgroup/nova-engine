...
public enum NovaEngineCanvasA2UICommand: String, Codable, Sendable {
...
public struct NovaEngineCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct NovaEngineCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
