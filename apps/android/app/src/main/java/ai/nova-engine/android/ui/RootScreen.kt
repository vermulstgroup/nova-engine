...
import ai.nova-engine.android.CameraHudKind
  ...
  AndroidView(
    ...
    factory = {
      WebView(context).apply {
        ...
        if (isDebuggable) {
          Log.d("NovaEngineWebView", "userAgent: ${settings.userAgentString}")
        }
        ...
        webViewClient =
          object : WebViewClient() {
            override fun onReceivedError(
              ...
              Log.e("NovaEngineWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
            }
            ...
            override fun onPageFinished(view: WebView, url: String?) {
              if (isDebuggable) {
                Log.d("NovaEngineWebView", "onPageFinished: $url")
              }
...
private class CanvasA2UIActionBridge(private val onMessage: (String) -> Unit) {
  ...
  companion object {
    const val interfaceName: String = "nova-engineCanvasA2UIAction"
  }
}
