...
function resolveWatchPaths(workspaceDir: string, config?: NovaEngineConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: NovaEngineConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: NovaEngineConfig }) {
