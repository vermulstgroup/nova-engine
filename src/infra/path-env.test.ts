...
let ensureNovaEngineCliOnPath: typeof import("./path-env.js").ensureNovaEngineCliOnPath;

describe("ensureNovaEngineCliOnPath", () => {
  const envKeys = [
    "PATH",
  ...
  beforeAll(async () => {
    ({ ensureNovaEngineCliOnPath } = await import("./path-env.js"));
  });
