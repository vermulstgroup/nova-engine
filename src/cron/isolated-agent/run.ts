...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/nova-engine/nova-engine/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.NOVA_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.nova-engine/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: Nova EngineConfig = {
    ...params.cfg,
