...
${formatHelpExamples([
  ['nova-engine message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'nova-engine message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'nova-engine message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.nova-engine.ai/cli/message")}`,
    )
    .action(() => {
