...
export function applyCliProfileEnv(params: {
  ...
  env.NOVA_PROFILE = profile;

  const stateDir = env.NOVA_STATE_DIR?.trim() || resolveProfileStateDir(profile, env, homedir);
  if (!env.NOVA_STATE_DIR?.trim()) {
    env.NOVA_STATE_DIR = stateDir;
  }
