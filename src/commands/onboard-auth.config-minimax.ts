...
export function applyMinimaxProviderConfig(cfg: NovaEngineConfig): NovaEngineConfig {
...
export function applyMinimaxConfig(cfg: NovaEngineConfig): NovaEngineConfig {
