...
export function summarizeExistingConfig(config: Nova EngineConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.nova-engine.ai/gateway/remote",
    "https://docs.nova-engine.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
