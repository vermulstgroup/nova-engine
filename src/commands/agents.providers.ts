...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: NovaEngineConfig): boolean {
...
export function summarizeBindings(cfg: NovaEngineConfig, bindings: AgentBinding[]): string[] {
