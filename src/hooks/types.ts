...
export type Nova EngineHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "nova-engine-bundled" | "nova-engine-managed" | "nova-engine-workspace" | "nova-engine-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: Nova EngineHookMetadata;
