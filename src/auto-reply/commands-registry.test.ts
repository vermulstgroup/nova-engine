...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@nova-engine", { botUsername: "nova-engine" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@nova-engine args", {
        botUsername: "nova-engine",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@nova-engine: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "nova-engine" })).toBe(
      "/help@otherbot",
    );
  });
