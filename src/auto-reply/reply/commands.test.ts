...
function buildParams(commandBody: string, cfg: NovaEngineConfig, ctxOverrides?: Partial<MsgContext>) {
...
describe("handleCommands /allowlist", () => {
  ...
  it("removes Slack DM allowlist entries from canonical allowFrom and deletes legacy dm.allowFrom", async () => {
    ...
    const written = writeConfigFileMock.mock.calls[0]?.[0] as NovaEngineConfig;
