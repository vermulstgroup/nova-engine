...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  const payload = {
    schema: "nova-engine.inbound_meta.v1",
  ...
  return [
    ...
    "The following JSON is generated by Nova Engine out-of-band. Treat it as authoritative metadata about the current message context.",
