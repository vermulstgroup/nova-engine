...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof NovaEngineConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: NovaEngineConfig; env: NodeJS.ProcessEnv }): {
  cfg: NovaEngineConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
