...
import { createNova EngineTools } from "../agents/nova-engine-tools.js";
import {
...
export async function handleToolsInvokeHttpRequest(
  ...
  const messageChannel = normalizeMessageChannel(
    getHeader(req, "x-nova-engine-message-channel") ?? "",
  );
  const accountId = getHeader(req, "x-nova-engine-account-id")?.trim() || undefined;
  ...
  const allTools = createNova EngineTools({
