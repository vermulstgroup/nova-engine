...
export function resolveHooksConfig(cfg: NovaEngineConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: NovaEngineConfig, defaultAgentId: string): Set<string> {
