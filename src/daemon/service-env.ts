...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.NOVA_STATE_DIR;
  const configPath = env.NOVA_CONFIG_PATH;
  return {
    HOME: env.HOME,
    ...
    NOVA_GATEWAY_PORT: String(port),
    NOVA_GATEWAY_TOKEN: token,
    NOVA_LAUNCHD_LABEL: resolvedLaunchdLabel,
    NOVA_SYSTEMD_UNIT: systemdUnit,
    NOVA_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    NOVA_SERVICE_KIND: GATEWAY_SERVICE_KIND,
