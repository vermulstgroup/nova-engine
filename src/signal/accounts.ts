...
export function listSignalAccountIds(cfg: Nova EngineConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: Nova EngineConfig): string {
...
function mergeSignalAccountConfig(cfg: Nova EngineConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: Nova EngineConfig): ResolvedSignalAccount[] {
