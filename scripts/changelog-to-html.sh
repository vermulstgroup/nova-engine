...
if [[ -z "$version_content" ]]; then
  echo "<h2>Nova Engine $VERSION</h2>"
  echo "<p>Latest Nova Engine update.</p>"
  echo "<p><a href=\"https://github.com/nova-engine/nova-engine/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
