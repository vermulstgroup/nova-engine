...
- Keep product names in English: Nova Engine, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Nova Engine Gateway, use “Gateway 网关”.
