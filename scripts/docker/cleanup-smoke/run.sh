...
export NOVA_STATE_DIR="/tmp/nova-engine-test"
export NOVA_CONFIG_PATH="${NOVA_STATE_DIR}/nova-engine.json"
...
pnpm nova-engine reset --scope config+creds+sessions --yes --non-interactive
...
pnpm nova-engine uninstall --state --yes --non-interactive
