...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "nova-engine", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Nova Engine. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Nova Engine Issue Label Audit");
