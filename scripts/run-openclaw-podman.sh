...
NOVA_USER="${NOVA_PODMAN_USER:-openclaw}"
...
LAUNCH_SCRIPT="$NOVA_HOME/run-openclaw-podman.sh"
...
CONFIG_DIR="${NOVA_CONFIG_DIR:-$EFFECTIVE_HOME/.openclaw}"
ENV_FILE="${NOVA_PODMAN_ENV:-$CONFIG_DIR/.env}"
WORKSPACE_DIR="${NOVA_WORKSPACE_DIR:-$CONFIG_DIR/workspace}"
CONTAINER_NAME="${NOVA_PODMAN_CONTAINER:-openclaw}"
NOVA_IMAGE="${NOVA_PODMAN_IMAGE:-openclaw:local}"
