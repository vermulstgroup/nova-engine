...
Nostr DM channel plugin for Nova Engine using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Nova Engine. It enables your bot to:
...
# Configure nova-engine to use local relay
