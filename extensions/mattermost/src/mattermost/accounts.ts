...
export function listMattermostAccountIds(cfg: Nova EngineConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: Nova EngineConfig): string {
...
export function listEnabledMattermostAccounts(cfg: Nova EngineConfig): ResolvedMattermostAccount[] {
