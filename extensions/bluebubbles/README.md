...
This directory contains the **BlueBubbles external channel plugin** for Nova Engine.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `nova-engine/plugin-sdk` helpers.
