...
- **GitHub:** https://github.com/nova-engine/nova-engine
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@nova-engine](https://x.com/nova-engine)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/nova-engine/nova-engine/discussions) or ask in Discord first
3. **Questions** → Discord #setup-help

## Before You PR

- Test locally with your Nova Engine instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for Nova Engine skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/nova-engine/nova-engine/issues) for "good first issue" labels!
