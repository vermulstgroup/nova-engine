...
This guide summarizes a sane workflow for working on the pi integration in Nova Engine.
...
- Trigger the agent directly:
  - `pnpm nova-engine agent --message "Hello" --thinking low`
...
State lives under the Nova Engine state directory. Default is `~/.nova-engine`. If `NOVA_STATE_DIR` is set, use that directory instead.

To reset everything:

- `nova-engine.json` for config
...
- [https://docs.nova-engine.ai/testing](https://docs.nova-engine.ai/testing)
- [https://docs.nova-engine.ai/start/getting-started](https://docs.nova-engine.ai/start/getting-started)
