...
本指南总结了在 Nova Engine 中开发 Pi 集成的合理工作流程。
...
状态存储在 Nova Engine 状态目录下。默认为 `~/.nova-engine`。如果设置了 `NOVA_STATE_DIR`，则使用该目录。

要重置所有内容：

- `nova-engine.json` 用于配置
...
- https://docs.nova-engine.ai/testing
- https://docs.nova-engine.ai/start/getting-started
