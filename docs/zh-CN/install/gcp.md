...
```bash
NOVA_IMAGE=openclaw:latest
NOVA_GATEWAY_TOKEN=change-me-now
NOVA_GATEWAY_BIND=lan
NOVA_GATEWAY_PORT=18789

NOVA_CONFIG_DIR=/home/$USER/.openclaw
NOVA_WORKSPACE_DIR=/home/$USER/.openclaw/workspace
...
services:
  openclaw-gateway:
    ...
    volumes:
      - ${NOVA_CONFIG_DIR}:/home/node/.openclaw
      - ${NOVA_WORKSPACE_DIR}:/home/node/.openclaw/workspace
    ports:
