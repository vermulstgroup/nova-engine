...
- 生成的 Swift 模型：`apps/macos/Sources/Nova EngineProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/nova-engine/nova-engine/main/dist/protocol.schema.json
