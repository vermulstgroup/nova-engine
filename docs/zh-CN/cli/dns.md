...
read_when:
  ...
  - You’re setting up split DNS for a custom discovery domain (example: nova-engine.internal)
summary: "`nova-engine dns` 的 CLI 参考（广域设备发现辅助工具）"
title: dns
x-i18n:
