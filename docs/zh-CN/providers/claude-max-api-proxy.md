...
你可以将 Nova Engine 指向该代理作为自定义 OpenAI 兼容端点：
...
- 这是一个**社区工具**，并非由 Anthropic 或 Nova Engine 官方支持
...
- [Anthropic 提供商](/providers/anthropic) - Nova Engine 与 Claude 的原生集成，使用 setup-token 或 API 密钥
