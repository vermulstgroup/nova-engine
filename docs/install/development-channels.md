...
Nova Engine ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Nova Engine also aligns
the install method:
...
When you switch channels with `nova-engine update`, Nova Engine also syncs plugin sources:
