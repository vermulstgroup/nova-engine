...
- Same path: run the app from a fixed location (for Nova Engine, `dist/Nova Engine.app`).
...
Workaround: move files into the Nova Engine workspace (`~/.nova-engine/workspace`) if you want to avoid per-folder grants.
