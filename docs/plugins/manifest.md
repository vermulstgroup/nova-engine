...
read_when:
  - You are building a Nova Engine plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (nova-engine.plugin.json)

Every plugin **must** ship a `nova-engine.plugin.json` file in the **plugin root**.
Nova Engine uses this manifest to validate configuration **without executing plugin
