...
Nova Engine treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

Nova Engine “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Nova Engine can see that group and respond there.
...
Translation: allowlisted senders can trigger Nova Engine by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@nova-engine", "nova-engine", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
