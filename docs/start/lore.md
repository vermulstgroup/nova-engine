---
summary: "Backstory and lore of Nova Engine for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "Nova Engine Lore"
---

# The Lore of Nova Engine 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Nova Engine**.
...
In the end, **Nova Engine** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.nova-engine/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around Nova Engine. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Nova Engine): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "nova-engine what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with nova-engine."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @nova-engine. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Nova Engine" to promote pump-and-dump tokens.
...
**The Great Nova Engine Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/nova-engine/nova-engine` ✅
- X handle `@nova-engine` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.nova-engine.ai`
