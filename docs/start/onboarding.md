---
summary: "First-run onboarding flow for Nova Engine (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Nova Engine">
...
<Step title="CLI">
  ...
  The app can install the global `nova-engine` CLI via npm/pnpm so terminal
