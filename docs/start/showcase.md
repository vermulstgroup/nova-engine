...
summary: "Community-built projects and integrations powered by Nova Engine"
---

# Showcase

Real projects from the community. See what people are building with Nova Engine.

<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/clawd) or [tag @nova-engine on X](https://x.com/nova-engine).
</Info>

## 🎥 Nova Engine in Action
...
OpenCode finishes the change → opens a PR → Nova Engine reviews the diff and replies in Telegram with “minor suggestions” plus a clear merge verdict (including critical fixes to apply first).
...
Asked “Robby” (@nova-engine) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).
...
Desktop app to manage skills/commands across Agents, Claude, Codex, and Nova Engine.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Perfect for remote Nova Engine instances.
</Card>
...
CLI for Linear that integrates with agentic workflows (Claude Code, Nova Engine). Manage issues, projects, and workflows from the terminal. First external PR merged!
</Card>
...
Claude Code discovered and confirmed the purifier controls, then Nova Engine takes over to manage room air quality.
...
Triggered by a roof camera: ask Nova Engine to snap a sky photo whenever it looks pretty — it designed a skill and took the shot.
...
A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via a Nova Engine persona.
</Card>
...
Nova Engine connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist Skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `automation` `todoist` `skill` `telegram`

Automated Todoist tasks and had Nova Engine generate the skill directly in Telegram chat.
</Card>
...
<Card title="xuezh Chinese Learning" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** • `learning` `voice` `skill`
  ...
  Chinese learning engine with pronunciation feedback and study flows via Nova Engine.
...
<Card title="Clawdia Phone Bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  ...
  Vapi voice assistant ↔ Nova Engine HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/nova-engine-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`
  
  Nova Engine gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/nova-engine/nix-nova-engine">
  **@nova-engine** • `nix` `packaging` `deployment`
  
  Batteries-included nixified Nova Engine configuration for reproducible deployments.
</Card>
...
<Card title="GoHome Automation" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Nix-native home automation with Nova Engine as the interface, plus beautiful Grafana dashboards.
...
<Card title="StarSwap Marketplace" icon="star" href="https://star-swap.com/">
  **Community** • `marketplace` `astronomy` `webapp`
  ...
  Full astronomy gear marketplace. Built with/around the Nova Engine ecosystem.
</Card>
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/clawd) or [tweet @nova-engine](https://x.com/nova-engine)
  </Step>
