...
summary: Machine-checked security models for Nova Engine’s highest-risk paths.
permalink: /security/formal-verification/
---

# Formal Verification (Security Models)

This page tracks Nova Engine’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Nova Engine enforces its
...
**What this is not (yet):** a proof that “Nova Engine is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/nova-engine-formal-models](https://github.com/vignesh07/nova-engine-formal-models).
...
```bash
git clone https://github.com/vignesh07/nova-engine-formal-models
cd nova-engine-formal-models
