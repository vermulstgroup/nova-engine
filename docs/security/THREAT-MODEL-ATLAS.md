...
This is a living document maintained by the Nova Engine community. See [CONTRIBUTING-THREAT-MODEL.md](./CONTRIBUTING-THREAT-MODEL.md) for guidelines on contributing:
...
This threat model documents adversarial threats to the Nova Engine AI agent platform and ClawHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component              | Included | Notes                                            |
| ---------------------- | -------- | ------------------------------------------------ |
| Nova Engine Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
...
| **Description**         | Attacker scans for exposed Nova Engine gateway endpoints                |
...
| **Affected Components** | ~/.nova-engine/credentials/, config storage                    |
...
| ATLAS ID      | Technique Name                 | Nova Engine Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ClawHub**          | Nova Engine's skill marketplace                              |
| **Gateway**          | Nova Engine's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for Nova Engine agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@nova-engine.ai_
