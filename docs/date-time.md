...
Nova Engine defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, Nova Engine inspects the OS preference (macOS/Windows)
