...
read_when:
  ...
  - Wiring external systems into Nova Engine
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Nova Engine config directory (typically `~/.nova-engine/hooks/transforms`).
...
- `nova-engine webhooks gmail setup` writes `hooks.gmail` config for `nova-engine webhooks gmail run`.
