---
summary: "Use Synthetic's Anthropic-compatible API in Nova Engine"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Nova Engine registers it as the
...
Note: Nova Engine's Anthropic client appends `/v1` to the base URL, so use
