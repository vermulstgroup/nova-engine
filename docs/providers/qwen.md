---
summary: "Use Qwen OAuth (free tier) in Nova Engine"
read_when:
  - You want to use Qwen with Nova Engine
...
If you already logged in with the Qwen Code CLI, Nova Engine will sync credentials
