...
Deepgram is a speech-to-text API. In Nova Engine it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Nova Engine uploads the audio file to Deepgram and injects the transcript
