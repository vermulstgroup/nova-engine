---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Nova Engine"
read_when:
  - You want Xiaomi MiMo models in Nova Engine
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Nova Engine uses
