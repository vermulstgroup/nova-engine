...
You can point Nova Engine at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Nova Engine
...
- [Anthropic provider](/providers/anthropic) - Native Nova Engine integration with Claude setup-token or API keys
