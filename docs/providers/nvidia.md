---
summary: "Use NVIDIA's OpenAI-compatible API in Nova Engine"
read_when:
  - You want to use NVIDIA models in Nova Engine
...
nova-engine onboard --auth-choice skip
nova-engine models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
