---
summary: "Use Qianfan's unified API to access many models in Nova Engine"
read_when:
...
3. Nova Engine installed on your system
...
4. Copy the API key for use with Nova Engine

## CLI setup

```bash
nova-engine onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Nova Engine Configuration](/gateway/configuration)
